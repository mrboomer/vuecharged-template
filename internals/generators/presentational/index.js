  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path:
          '../../src/components/presentational/{{properCase name}}/index.vue',
      ...
      },
      {
        type: 'add',
        path:
          '../../src/components/presentational/{{properCase name}}/tests/index.spec.js',
    ...
    if (data.wantI18n) {
      actions.push({
        type: 'add',
        path:
          '../../src/components/presentational/{{properCase name}}/messages.js',
